      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 md:px-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            ...
            className="inline-flex items-center gap-3 bg-gold-400 text-cream-50 font-sans font-500 tracking-widest uppercase text-xs px-10 py-5 transition-all duration-300 hover:bg-gold-500 hover:shadow-2xl hover:shadow-gold-400/30 active:scale-95 rounded-[25px]"
          >
            {/* WhatsApp icon */}
